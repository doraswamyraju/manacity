    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        <div style={{
          ...
          alignItems: 'center',
          gap: '0.5rem',
          boxShadow: isDark ? '0 4px 15px rgba(236, 72, 153, 0.15)' : '0 2px 8px rgba(236, 72, 153, 0.1)'
        }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
        ...
        >
          <RefreshCw size={15} color={isDark ? '#f472b6' : '#db2777'} />
          <span style={{ fontSize: '0.78rem', fontWeight: 600, color: isDark ? '#fbcfe8' : '#be185d' }}>Sync Live</span>
        </button>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
              <span style={{ fontSize: '0.85rem', fontWeight: 700, color: isDark ? '#fff' : '#0f172a', lineHeight: 1.1 }}>{user?.name || 'Customer User'}</span>
              <span style={{ backgroundColor: 'rgba(236, 72, 153, 0.2)', border: '1px solid rgba(236, 72, 153, 0.4)', borderRadius: '4px', fontSize: '0.62rem', fontWeight: 800, color: '#f472b6', padding: '0.05rem 0.3rem' }}>USER</span>
            </div>
