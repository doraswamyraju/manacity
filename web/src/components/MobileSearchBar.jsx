...
export default function MobileSearchBar({ selectedCity = 'tirupati' }) {
  ...
  // Highlight matching query prefix in item title
  ...
  return (
    <div ref={searchContainerRef} style={{ width: '100%', position: 'relative', boxSizing: 'border-box' }}>
      ...
      <div style={{
        ...
        boxShadow: '0 4px 18px rgba(37, 99, 235, 0.15)'
      }}>
        <div style={{
          display: 'flex',
          alignItems: 'center',
          ...
          {query ? (
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', backgroundColor: '#eff6ff', border: '1px solid #bfdbfe', padding: '0.2rem 0.5rem', borderRadius: '12px', cursor: 'pointer', flexShrink: 0 }}>
              <Mic size={13} color="#2563eb" />
              <span style={{ fontSize: '0.7rem', fontWeight: 800, color: '#2563eb' }}>Voice</span>
            </div>
          )}
        </div>
      </div>

      {/* JustDial-Style Clean Mobile Suggestions Dropdown */}
      {showSuggestions && (
        <div style={{
          position: 'absolute',
          top: 'calc(100% + 6px)',
              ...
              {masterSuggestions.map((mItem, mIdx) => (
                ...
                >
                  <div style={{ flex: 1, paddingRight: '0.5rem' }}>
                    ...
                    <div style={{ fontSize: '0.72rem', color: '#64748b', marginTop: '0.1rem', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                ...
                >
                  <div style={{ flex: 1, paddingRight: '0.5rem' }}>
                    <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#0f172a', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                      ...
                      <span style={{ backgroundColor: '#ecfdf5', color: '#047857', border: '1px solid #a7f3d0', fontSize: '0.6rem', fontWeight: 800, padding: '0.05rem 0.35rem', borderRadius: '8px' }}>
                        Verified
                      </span>
                    </div>
                    <div style={{ fontSize: '0.72rem', color: '#64748b', marginTop: '0.1rem' }}>
                      <span style={{ backgroundColor: '#059669', color: '#fff', fontWeight: 800, padding: '0.05rem 0.3rem', borderRadius: '4px', fontSize: '0.65rem', marginRight: '0.35rem' }}>
