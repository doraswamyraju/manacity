...
export default function DesktopSearchBar({ selectedCity = 'tirupati' }) {
  ...
  // Translucent Ghost Completion Text for Desktop
  ...
  return (
    <div ref={searchContainerRef} style={{ flex: '1 1 380px', maxWidth: '650px', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', width: '100%', display: 'flex', alignItems: 'center' }}>
            ...
            {/* Desktop Ghost Auto-Suggest Text */}
      ...
      {/* RICH DESKTOP SEARCH OVERLAY DROPDOWN (Pristine Cards, Badges, Action Buttons, Filters) */}
      {showSuggestions && (
        <div style={{
          position: 'absolute',
          top: 'calc(100% + 10px)',
          ...
          {/* SECTION 1: MASTER PRODUCTS & SERVICES CATALOG */}
          ...
          {/* SECTION 2: MANACITY REGISTERED VERIFIED BUSINESSES (Rich Cards + Action Buttons) */}
                ...
                {suggestions.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', marginTop: '0.55rem', paddingTop: '0.45rem', borderTop: '1px solid #f1f5f9' }}>
                        <button
                          type="button"
          ...
          {/* SECTION 3: NEARBY LOCAL AREA LISTINGS */}
